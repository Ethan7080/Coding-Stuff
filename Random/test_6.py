...
#changing the logo
logo = pygame.image.load('About.png')
...
def introImg(x,y):
    intro = pygame.image.load("fruitninja_background.png")
    
    screen.blit(intro,(x,y))
def instructionIMG(x,y):
    instruct = pygame.image.load("fruitninja_background.png")
    run = True
    while run:
...
def aboutIMG(x,y):
    aboutimg = pygame.image.load("fruitninja_background.png")
    run = True
    while run:
...
def introscreen():
    run = True
    pygame.mixer.music.load('fruitninja_music.wav')
...
def countdown():
    ...
    countdownBacground = pygame.image.load('fruitninja_background.png')
...
def gameloop():
    ...
    #highscore part
    with open ("fruitninja_background.png") as f:
            highscore = f.read()
    ...
    def gameover():
        gameoverImg = pygame.image.load("fruitninja_background.png")
        run = True
        while run:
    ...
    bg = pygame.image.load('fruitninja_background.png')
    
    
    # setting our player
    maincar = pygame.image.load('fruitninja_background.png')
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    #other cars
    car1 = pygame.image.load('fruitninja_background.png')
    car1X = random.randint(178,490)
    car1Y = 100
    car1Ychange = 10    
    car2 = pygame.image.load('fruitninja_background.png')
    car2X = random.randint(178,490)
    car2Y = 100
    car2Ychange = 10

    car3 = pygame.image.load('fruitninja_background.png')
